    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_type', models.CharField(choices=[('home', 'Home'), ('outlet', 'Outlet')], default='home', max_length=100)),
                ('payment_method', models.CharField(choices=[('card', 'Card'), ('cash_on_delivery', 'Cash on Delivery')], default='card', max_length=100)),
                ...
                ('recevied_at', models.DateTimeField(blank=True, null=True)),
