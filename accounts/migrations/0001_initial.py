    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_photo', models.ImageField(blank=True, null=True, upload_to='cover_photos/', verbose_name='cover photo')),
                ...
                ('stripe_account_id', models.CharField(blank=True, max_length=255, null=True, verbose_name='stripe account id')),
                ('is_onboarding_completed', models.BooleanField(default=False, verbose_name='is onboarded')),
