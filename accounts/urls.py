...
from accounts.views import AddEmailView, AddPhoneNumberView, ChangeEmailView, ChangePasswordView, ChangePhoneNumberView, RegisterView, LoginView, LogoutView, SendOTPView, UserLockView, UserProfileView
